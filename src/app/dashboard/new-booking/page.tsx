          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-base">
                ...
                processed. You should receive a booking confirmation from us shortly.
              </DialogDescription>
            ...
            <div className="py-4">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-md p-4 mb-4">
                <h4 className="font-medium text-slate-800 mb-2">
                  For urgent support, changes, or cancellations - (within 24 hours) please contact us via WhatsApp.
                </h4>
