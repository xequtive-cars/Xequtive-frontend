...
import { Plus, X, GripVertical, Loader2, ArrowRight, Minus } from "lucide-react";
        ...
        <Card className="w-[100%] md:w-[110%] booking-form-card">
          <CardContent>
            <div className="space-y-4">
              ...
              {/* 4. Hours, Passengers, Luggage, Multiple Vehicles */}
              <div className="space-y-3">
                ...
                {bookingType === 'hourly' && (
                  <div className="space-y-2 p-3 border rounded-md bg-muted/20">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-muted-foreground">4-24 hours</span>
                    </div>
                    <Slider
                      value={[hours]}
                      onValueChange={(value) => {
